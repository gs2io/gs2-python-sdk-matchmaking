...
class PasscodeEarlyCompleteGatheringRequest(Gs2UserRequest):

    class Constant(Gs2Matchmaking):
        FUNCTION = "EarlyCompleteGathering"
    ...
    def __init__(self, params=None):
        ...
        """
        super(PasscodeEarlyCompleteGatheringRequest, self).__init__(params)
        if params is None:
    ...
    def with_matchmaking_name(self, matchmaking_name):
        ...
        :type matchmaking_name: unicode
        :return: this
        :rtype: PasscodeEarlyCompleteGatheringRequest
        """
    ...
    def set_gathering_id(self, gathering_id):
        """
        ギャザリングIDを指定します。を設定
        :param gathering_id: ギャザリングIDを指定します。
        :type gathering_id: unicode
        """
        if gathering_id is not None and not (isinstance(gathering_id, str) or isinstance(gathering_id, unicode)):
