...
class DeleteMatchmakingRequest(Gs2BasicRequest):

    class Constant(Gs2Matchmaking):
        FUNCTION = "DeleteMatchmaking"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DeleteMatchmakingRequest, self).__init__(params)
        if params is None:
    ...
    def with_matchmaking_name(self, matchmaking_name):
        ...
        :type matchmaking_name: unicode
        :return: this
        :rtype: DeleteMatchmakingRequest
        """
