...
class DescribeMatchmakingRequest(Gs2BasicRequest):

    class Constant(Gs2Matchmaking):
        FUNCTION = "DescribeMatchmaking"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeMatchmakingRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeMatchmakingRequest
        """
