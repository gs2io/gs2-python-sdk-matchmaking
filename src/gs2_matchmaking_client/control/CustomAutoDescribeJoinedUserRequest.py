...
class CustomAutoDescribeJoinedUserRequest(Gs2UserRequest):
    ...
    def __init__(self, params=None):
        ...
        """
        super(CustomAutoDescribeJoinedUserRequest, self).__init__(params)
        if params is None:
    ...
    def with_matchmaking_name(self, matchmaking_name):
        ...
        :type matchmaking_name: unicode
        :return: this
        :rtype: CustomAutoDescribeJoinedUserRequest
        """
