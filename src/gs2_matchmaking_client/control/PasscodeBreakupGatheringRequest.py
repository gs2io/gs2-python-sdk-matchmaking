...
class PasscodeBreakupGatheringRequest(Gs2UserRequest):

    class Constant(Gs2Matchmaking):
        FUNCTION = "BreakupGathering"
    ...
    def __init__(self, params=None):
        ...
        """
        super(PasscodeBreakupGatheringRequest, self).__init__(params)
        if params is None:
    ...
    def with_matchmaking_name(self, matchmaking_name):
        ...
        :type matchmaking_name: unicode
        :return: this
        :rtype: PasscodeBreakupGatheringRequest
        """
