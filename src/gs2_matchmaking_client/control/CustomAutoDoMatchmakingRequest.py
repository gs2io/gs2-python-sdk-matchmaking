...
class CustomAutoDoMatchmakingRequest(Gs2UserRequest):
    ...
    def set_attribute1(self, attribute1):
        ...
        :type attribute1: int
        """
        if _attribute1 and not isinstance(_attribute1, int):
    ...
    def set_attribute2(self, attribute2):
        ...
        :type attribute2: int
        """
        if _attribute2 and not isinstance(_attribute2, int):
    ...
    def set_attribute3(self, attribute3):
        ...
        :type attribute3: int
        """
        if _attribute3 and not isinstance(_attribute3, int):
    ...
    def set_attribute4(self, attribute4):
        ...
        :type attribute4: int
        """
        if _attribute4 and not isinstance(_attribute4, int):
    ...
    def set_attribute5(self, attribute5):
        ...
        :type attribute5: int
        """
        if _attribute5 and not isinstance(_attribute5, int):
    ...
    def set_search_attribute1_min(self, search_attribute1_min):
        ...
        """
        if _search_attribute1_min and not isinstance(_search_attribute1_min, int):
    ...
    def set_search_attribute2_min(self, search_attribute2_min):
        ...
        """
        if _search_attribute2_min and not isinstance(_search_attribute2_min, int):
    ...
    def set_search_attribute3_min(self, search_attribute3_min):
        ...
        """
        if _search_attribute3_min and not isinstance(_search_attribute3_min, int):
    ...
    def set_search_attribute4_min(self, search_attribute4_min):
        ...
        """
        if _search_attribute4_min and not isinstance(_search_attribute4_min, int):
    ...
    def set_search_attribute5_min(self, search_attribute5_min):
        ...
        """
        if _search_attribute5_min and not isinstance(_search_attribute5_min, int):
    ...
    def set_search_attribute1_max(self, search_attribute1_max):
        ...
        """
        if _search_attribute1_max and not isinstance(_search_attribute1_max, int):
    ...
    def set_search_attribute2_max(self, search_attribute2_max):
        ...
        """
        if _search_attribute2_max and not isinstance(_search_attribute2_max, int):
    ...
    def set_search_attribute3_max(self, search_attribute3_max):
        ...
        """
        if _search_attribute3_max and not isinstance(_search_attribute3_max, int):
    ...
    def set_search_attribute4_max(self, search_attribute4_max):
        ...
        """
        if _search_attribute4_max and not isinstance(_search_attribute4_max, int):
    ...
    def set_search_attribute5_max(self, search_attribute5_max):
        ...
        """
        if _search_attribute5_max and not isinstance(_search_attribute5_max, int):
    ...
    def set_search_context(self, search_context):
        ...
        """
        if _search_context and not (isinstance(_search_context, str) or isinstance(_search_context, unicode)):
